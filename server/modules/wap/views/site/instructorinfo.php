    ...
    <div class="container" style="margin-bottom: 3.08333rem">
        ...
        <div class="content-box instructorinfo-info">
            ...
            <div class="detail">
                ...
                <div class="name" style="font-weight: 400;margin-top: 1.45833rem;">4年工作经验</div>
                <div class="tip2">
    ...
    <div class="container2">
        ...
        <div class="content-box">
            <div class="flex-box instructorinfo-book-list">
                ...
                <p class="instructor-name">人力资源管理师</p>
            </div>
            <div class="flex-box instructorinfo-book-list">
                <img src="https://f.cdn.xsteach.cn/uploaded/c1/85/3f/c1853f5f3ce63f633710a0eac17e5de8001.jpg" alt="">
                <p class="instructor-name">人力资源管理师</p>
    ...
    <div class="container3">
        ...
        <div class="content-box instructorinfo-video">
            <div class="item flex-box">
                <img src="https://f.cdn.xsteach.cn/uploaded/c1/85/3f/c1853f5f3ce63f633710a0eac17e5de8001.jpg" alt="" >
                <div class="tip2">
                    4A广告公司首席设计师 、艺术指导、资深业界专家、品牌视觉设计师、Adobe全国优秀讲师、文化部中文发广告公司设计总监。
                </div>
            </div>
            <div class="item flex-box">
                <img src="https://f.cdn.xsteach.cn/uploaded/c1/85/3f/c1853f5f3ce63f633710a0eac17e5de8001.jpg" alt="" >
